...
function App() {
  ...
  useEffect(() => {
    axios
      .get("https://inspo-board-backend-haam-e0458211a663.herokuapp.com/boards", {})
      .then((response) => {
  ...
  const getBoardCards = (board_id) => {
    axios
      .get(
        `https://inspo-board-backend-haam-e0458211a663.herokuapp.com/boards/${board_id}/cards`
      )
      .then((response) => {
  ...
  const createNewBoard = (newBoard) => {
    axios
      .post(
        "https://inspo-board-backend-haam-e0458211a663.herokuapp.com/boards", newBoard
      )
      .then((response) => {
  ...
  const deleteOneBoard = (board_id) => {
    axios
      .delete(
        `https://inspo-board-backend-haam-e0458211a663.herokuapp.com/boards/${board_id}`
      )
      .then((response) => {
  ...
  const deleteAllBoards = (boards) => {
    axios
    .delete(
      "https://inspo-board-backend-haam-e0458211a663.herokuapp.com/boards"
      )
    .then((response) => {;
      setBoardsData([])
      resetSelectBoard();
  ...
  const createNewCard = (message) => {
    axios
      .post(
        `https://inspo-board-backend-haam-e0458211a663.herokuapp.com/boards/${selectedBoard.board_id}/cards`,
        { message }
      )
      .then((response) => {
  ...
  const deleteCard = (cardId) => {
    axios
      .delete(
        `https://inspo-board-backend-haam-e0458211a663.herokuapp.com/cards/${cardId}`
      )
      .then((response) => {
  ...
  const updateLikes = async (cardId) => {
    try {
      const res = await axios.patch(`https://inspo-board-backend-haam-e0458211a663.herokuapp.com/boards/${selectedBoard.board_id}/cards/${cardId}`);
      onCardLikes(cardId);
    } catch(err) {
      console.error(err);
    }
